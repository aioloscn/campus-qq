    ...
    <view wx:if="{{registered}}">
        ...
        <view class="password-container">
            <view class="input-container">
                <input class="password" type="password" minlength="6" maxlength="16" placeholder="密码，长度6-16位" bindinput="inputPwd" auto-focus="true" value="{{password}}" />
            ...
            <view class="input-container">
                <input class="password" type="password" minlength="6" maxlength="16" placeholder="确认密码" bindinput="inputConfirmPwd" value="{{confirmPassword}}" />
