<view class="container" style="text-align: left;">
    <l-textarea bind:linconfirm="onConfirm" bind:lininput="inputTextarea" l-class="textarea" border="{{false}}" focus="{{true}}" maxlength="149" indicator="{{true}}" auto-height="{{true}}" placeholder="可以分享你的心情或发布简单的活动吧~" />
